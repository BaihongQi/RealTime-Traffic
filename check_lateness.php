...
foreach ($feed->getEntityList() as $entity) {
    ...
    $cmd= "select StopID from trips t where t.tripid= ".$entity->getVehicle()->getTrip()->getTripId()." and t.atime='".$now.":00';";
    #echo "query=".$cmd."</br>";
    ...
    if ($result->num_rows > 0){
      ...
      if ($result2->num_rows > 0){
        ...
        echo $row["BusHeader"]. " distance from stop: ". $distance*1000 . " Meters<br><br>";
